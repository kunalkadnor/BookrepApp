...
function Footer() {
  return (
   <>
   <div><footer className=" mt-5 footer p-10 bg-neutral text-neutral-content text-white">
    ...
    <aside>
      ...
      <p>ByteBooks<br/>All rights reserved</p>
    </aside>
   
    <nav>
    <div>
        <nav className="grid grid-flow-col gap-4">
    <a className="link link-hover">About us</a><br></br>
    <a className="link link-hover" href='/Contact'>Contact</a><br></br>
    <a className="link link-hover" href='/Course'>course</a><br></br>
    <a className="link link-hover"></a><br></br>
  </nav> 
  </div>
