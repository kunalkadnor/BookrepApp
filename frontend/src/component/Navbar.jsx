...
function Navbar() {
  ...
  return (
    <>
    <div className="bg-white max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 text-black" >
  ...
  <input type="text" className="bg-white grow outline-none" placeholder="Search" />
  ...
  <div className="">
    <a className="bg-white text-black px-3 py-2 rounded-md hover:bg-slate-300 duration-300 cursor-pointer" onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</a>
    <Login/>
  </div>
</div>
</div>
